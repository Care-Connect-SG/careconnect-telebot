...
class MessageHandler:
    ...
    async def _handle_task_query(self, update: Update, time_range: Dict[str, Any], filters: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if time_range and "start_time" in time_range and "end_time" in time_range:
                ...
                if time_range["start_time"].date() == time_range["end_time"].date():
                    ...
                    today_start = time_range["start_time"].replace(hour=0, minute=0, second=0, microsecond=0)
                    today_end = time_range["end_time"].replace(hour=23, minute=59, second=59, microsecond=999999)
    ...
    async def _handle_activity_query(self, update: Update, time_range: Dict[str, Any], filters: Dict[str, Any]) -> None:
